...
- **Свежесть:** только объявления за последние 24 ч (по дате публикации)
...
Python 3.11+, aiogram 3, curl_cffi, aiosqlite, shapely, asyncio poll loop
...
src/botfatir/
  ...
  poll.py        — цикл опроса и уведомления
  freshness.py   — фильтр по дате публикации
